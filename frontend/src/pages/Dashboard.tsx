...
export default function Dashboard() {
  ...
  const renderActivePage = () => {
    switch (activePage) {
      case 'Calendar':
        return React.createElement(Calendar, { onNavigateToTasks: () => setActivePage('My Tasks') });
      case 'My Tasks':
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
          {[
            ...
            { text: 'Clients', icon: <ViewKanbanIcon /> },
            { text: 'Calendar', icon: <CalendarTodayIcon /> },
            { text: 'All Tasks', icon: <ListAltIcon /> },
            { text: 'All Projects', icon: <FolderIcon /> },
            { text: 'Project Analytics', icon: <AnalyticsIcon /> },
          ].map((item) => (
