...
function EditProjectDialog({ open, onClose, project, onProjectUpdated }: EditProjectDialogProps) {
  ...
  const [hourlyRate, setHourlyRate] = useState<number | ''>(''); // Add this line
  ...
  useEffect(() => {
    if (project && open) {
      ...
      setHourlyRate(project.hourly_rate || ''); // Add this line
  ...
  const handleSave = async () => {
    ...
    try {
      const projectData = {
        ...
        client_id: clientId,
        hourly_rate: hourlyRate || undefined, // Add this line
      };
