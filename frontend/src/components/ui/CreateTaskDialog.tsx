...
function CreateTaskDialog({ open, onClose, onTaskCreated, defaultProjectId }: CreateTaskDialogProps) {
  ...
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="md" fullWidth>
      <FormDialogTitle>Create Task</FormDialogTitle>
      <FormDialogContent>
        ...
        <FormFormControl>
          <FormInputLabel shrink>Project</FormInputLabel>
          <FormSelect
          ...
          >
            <FormMenuItem value="">Not Selected</FormMenuItem>
        ...
        <FormFormControl>
          <FormInputLabel shrink>Priority</FormInputLabel>
          <FormSelect
            value={formData.priority}
            label="Priority"
            onChange={(e) => setFormData(prev => ({ ...prev, priority: e.target.value as 'Low' | 'Medium' | 'High' }))}
          >
            <FormMenuItem value="Low">🟢 Low</FormMenuItem>
            <FormMenuItem value="Medium">🟡 Medium</FormMenuItem>
            <FormMenuItem value="High">🔴 High</FormMenuItem>
          </FormSelect>
        </FormFormControl>
